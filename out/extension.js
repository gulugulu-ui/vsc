...
// 记录当前的终端
let simulatorTerminal;
function activate(context) {
    console.log('人车交互系统插件已激活');
    // 1. 注册侧边栏
    const treeProvider = new provider_1.BisheTreeProvider();
    ...
    let reportCmd = vscode.commands.registerCommand('my-bishe.showReport', () => {
        const panel = vscode.window.createWebviewPanel('bisheReport', '仿真分析报告', vscode.ViewColumn.One, { enableScripts: true });
